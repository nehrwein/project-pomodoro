...
Our goal for this project was to implement the knowledge that we had gained during the bootcamp and at the same time learn new skills and build a tool that would provide value to us as well as to potential users.
